...
/// Canonical font manifest: file names, faces, licenses, and SHA-256
/// hashes. The single source tree for document font bytes; consumers
/// must not retain copies of these bytes.
pub const MANIFEST: &str = include_str!("../fonts/manifest.json");
